...
const AroundYou = () => {
    ...
    useEffect(() => {
        axios.get('https://geo.ipify.org/api/v2/country?apiKey=at_qsLyioqWzd8wye0fIPSgLnfimpEmu')
    ...
    return (
        <div className='flex flex-col'>
            ...
            <div className='flex flex-wrap sm:justify-start justify-center gap-8'>
                {data?.map((song, i) => (
                    <SongCard key={SongCard.key} song={song} isPlaying={isPlaying} activeSong={activeSong} data={data}/>))}
            </div>
        </div>
    )
}
